...
* **Power BI Analytics Reports**:
  ...
  * [Bank Customer Churn Dashboard](https://github.com/mm-mazhar/PowerBI-Bank-Customers-Churn-Analysis)

---

## 📦 Python Packages & Tools

* **[`lasso-regression-model`](https://pypi.org/project/lasso-regression-model/)**: Modular, production-ready machine learning package published on PyPI.
* **[`pytubev3`](https://github.com/mm-mazhar/pytubev3)**: Lightweight, zero-dependency Python wrapper for the YouTube Data API v3.
* **[`imagedownloader`](https://github.com/mm-mazhar/imagedownloader)**: Python utility for downloading and archiving images in bulk from URLs and CSV files.
* **[Web Scrapers Suite](https://github.com/mm-mazhar/Scraping-Zameen.com)**: Large-scale scrapers with user-agent and proxy rotation for [Zameen.com (100k+ properties)](https://github.com/mm-mazhar/Scraping-Zameen.com), [Carrefour](https://github.com/mazqoty/Scraping-Carrefour-E-commerce), and [LuLu Hypermarket](https://github.com/mazqoty/Scraping-Lulu-Hypermarket-E-commerce).
